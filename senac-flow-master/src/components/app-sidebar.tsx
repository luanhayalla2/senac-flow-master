...
// import senacLogo from "@/assets/senac-logo.png"; // removed per request
import {
  LayoutDashboard,
  Inbox,
  PlusCircle,
    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-3 px-2 py-3">
                    <div className="h-9 w-9 rounded-md bg-primary/20 flex items-center justify-center text-xs font-bold">SHD</div>
          {!collapsed && (
            <div className="leading-tight min-w-0">
              <div className="font-display font-bold text-sm">Service Help Desk</div>
              <div className="text-[10px] uppercase tracking-widest text-sidebar-foreground/60">SENAC SERVICE HELP DESK</div>
            </div>
          )}
        </div>
      </SidebarHeader>
